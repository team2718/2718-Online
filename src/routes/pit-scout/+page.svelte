<script lang="ts">
    ...
    let error = $state("");
    let submitting = $state(false); // New state to prevent duplicates
    ...
    async function save(event: SubmitEvent) {
        ...
        if (submitting) return; // Prevention: Exit if already submitting
        ...
        try {
            ...
            // Check specifically for success type to fix false error messages
